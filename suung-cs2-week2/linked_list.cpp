/*
 * The program is leaking memory because heap memory allocated to Node
 * structures were not deleted.  This consumption of memory would 
 * cause the program to slow down and possibly crash.
 */
