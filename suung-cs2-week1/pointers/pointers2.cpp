...
{
    /* Let a be a pointer that does not correspond to any location in
     * memory. When unintialized,  its value was undefined.
     */

    /* 'a' was declared but not initialized. 
     * EDIT: 'a' was initialized to nullptr.
     */
